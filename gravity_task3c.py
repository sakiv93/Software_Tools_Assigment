...
ax.plot(positions_trace[0,0,0],positions_trace[0,0,1],'bo')
ax.plot(positions_trace[0,1,0],positions_trace[0,1,1],'bo')
ax.plot(positions_trace[-1,0,0],positions_trace[-1,0,1],'yD')
ax.plot(positions_trace[-1,1,0],positions_trace[-1,1,1],'yD')
ax.set(xlabel='X(m)',ylabel='Y(m)',title='Trace of the planets $(t_{0}:circles,t_{end}:diamonds)$')
plt.show()